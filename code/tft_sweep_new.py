...
def main() -> None:
    ...
    train_underlying, train_data, train_targets = get_tft_data(date(2012, 1, 1), date(2015, 1, 1), timesteps)
    val_underlying, val_data, val_targets = get_tft_data(date(2015, 1, 1), date(2015, 2, 1), timesteps)
